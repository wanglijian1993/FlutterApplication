...
part 'ProjectArticles.g.dart';

@JsonSerializable()
class ProjectArticles {
  DataBean data;
  num errorCode;
  String errorMsg;
  ...
  factory ProjectArticles.fromJson(Map<String, dynamic> json) =>
      _$ProjectArticlesFromJson(json);

  Map<String, dynamic> toJson() => _$ProjectArticlesToJson(this);
}

...
part of 'ProjectTabs.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProjectTabs _$ProjectTabsFromJson(Map<String, dynamic> json) => ProjectTabs(
...
Map<String, dynamic> _$ProjectTabsToJson(ProjectTabs instance) =>
    <String, dynamic>{
      'data': instance.data,

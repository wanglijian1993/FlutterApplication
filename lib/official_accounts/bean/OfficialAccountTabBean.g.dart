...
part of 'OfficialAccountTabBean.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OfficialAccountTabBean _$OfficialAccountTabBeanFromJson(
...
Map<String, dynamic> _$OfficialAccountTabBeanToJson(
        OfficialAccountTabBean instance) =>
    <String, dynamic>{
      'data': instance.data,
